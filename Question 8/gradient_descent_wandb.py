...
def stochastic_gradient_descent(k,weight, activation, weight_decay, X, Y, X_val, Y_val, iterations, alpha, layer_sizes, batch_size):
    epsilon = 0.
    if weight=='random':
...
def momentum_gradient_descent(k,weight, activation, weight_decay, X, Y, X_val, Y_val, iterations, alpha, beta, layer_sizes, batch_size):
    epsilon = 0.
    if weight=='random':
      params = init_params(layer_sizes)
    elif weight=='glorot':
...
def nesterov_gradient_descent(k,weight, activation, weight_decay, X, Y, X_val, Y_val,iterations, alpha, beta, layer_sizes, batch_size):
    epsilon = 0.
    if weight=='random':
      params = init_params(layer_sizes)
    elif weight=='glorot':
...
def stochastic_gradient_descent_with_adagrad(k,weight, activation, weight_decay, X, Y, X_val, Y_val,iterations, alpha, layer_sizes, batch_size, epsilon_v):
    k=50
    epsilon = 0.
    if weight=='random':
      params = init_params(layer_sizes)
...
def stochastic_gradient_descent_with_RMSProp(k,weight, activation, weight_decay, X, Y, X_val, Y_val, iterations, alpha, layer_sizes, batch_size, epsilon_v, beta):
    epsilon = 0.
    if weight=='random':
      params = init_params(layer_sizes)
    elif weight=='glorot':
...
def stochastic_gradient_descent_with_AdaDelta(k,weight, activation, weight_decay, X, Y, X_val, Y_val, iterations, alpha, layer_sizes, batch_size, epsilon_v, beta):
    epsilon = 0.
    if weight=='random':
      params = init_params(layer_sizes)
    elif weight=='glorot':
...
def stochastic_gradient_descent_with_adam(k,weight, activation, weight_decay, X, Y, X_val, Y_val,iterations, alpha, layer_sizes, batch_size, epsilon_v, beta1, beta2):
    epsilon = 0.
    if weight=='random':
      params = init_params(layer_sizes)
    elif weight=='glorot':
...
def stochastic_gradient_descent_with_nadam(k,weight, activation, weight_decay, X, Y, X_val, Y_val, iterations, alpha, layer_sizes, batch_size, epsilon_v, beta1, beta2):
    epsilon = 0.
    if weight=='random':
      params = init_params(layer_sizes)
    elif weight=='glorot':
